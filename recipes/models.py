...
class Recipe(models.Model):
    ...
    def get_htmx_url(self):
        return reverse("recipes:htmx-detail", kwargs={"id" : self.id})
...
class RecipeIngredients(models.Model):
    ...
    def get_ingredient_delete_url(self):
        kwargs = {
    ...
    def get_hx_edit_url(self):
        kwargs = {
            "parent_id" : self.recipe.id, 
            "id" : self.id}
        return reverse('recipes:htmx-ingredient-detail', kwargs=kwargs)
    ...
    def save(self, *args, **kwargs):
        qty = self.quantity
        qty_as_float, qty_as_success = number_str_to_float(qty)
        if qty_as_success:
